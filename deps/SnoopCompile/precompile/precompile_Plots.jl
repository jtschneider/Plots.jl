...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:w,), Tuple{Int64}},typeof(plot!),Vector{Float64},Vector{Float64},UnitRange{Int64}})
    ...
    Base.precompile(Tuple{typeof(get_thickness_scaling),Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(plotarea!),GridLayout,BoundingBox{Tuple{AbsoluteLength, AbsoluteLength}, Tuple{AbsoluteLength, AbsoluteLength}}})
